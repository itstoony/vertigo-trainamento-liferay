 ...
 * <code>com.liferay.training.contato.service.impl.ContatoLocalServiceImpl</code> and
...
public class ContatoLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.training.contato.service.impl.ContatoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Contato getContatoById(long id) throws PortalException {
		return getService().getContatoById(id);
	}
	...
	public static List<Contato> getContatosByGroupId(long groupId) {
	...
	public static Contato updateContato(
			long contatoId, String nome, String telefone, String email,
			int idade)
		throws PortalException {

		return getService().updateContato(
